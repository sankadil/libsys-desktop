...
public class DetailAdder extends JFrame  implements ActionListener
{
...
JLabel full_lable=new JLabel("Edit  Book Details");
...
id_label.setBounds(50,100,150,25);
id_label.setFont(f);
id_label.setForeground(ctf1);
jp1.add(id_label);

id=new JTextField("");
id.setBounds(300,100,280,25);
...
title_label.setBounds(50,135,150,25);
title_label.setFont(f);
title_label.setForeground(ctf1);
jp1.add(title_label);

title=new JTextField("");
title.setBounds(300,135,280,25);
title.setFont(f);
jp1.add(title);
...
try
{
String query1="Update select_to_order set   bookid='"+id.getText()+"' ,  title='"+title.getText()+"' ,author1='"+author1.getText()+"',author2='"+author2.getText()+"' ,author3='"+author3.getText()+"' ,edition='"+edition.getText()+"' ,isbn='"+isbn.getText()+"' ,publisher ='"+publisher.getText()+"' ,city= '"+city.getText()+"' ,year ='"+year.getText()+"' ,request ='"+request .getText()+"' , vender ='"+ vender .getText()+"' , copy ='"+number_copy.getText()+"' , price='"+ price.getText()+"' WHERE bookid='"+id.getText()+"'";
//System.out.println("\n"+query1+"\n");
