...
class LectureRecomendation extends JFrame implements ActionListener
{
 ...
 public LectureRecomendation(String un,String fname)
	{
...
//      p1.add(borlabel1);
      ...
      bt6.setBounds(730,570,90,40);
      bt6.addActionListener(this);
      p1.add(bt6);


      bt8 = new JButton("Recommend");
      bt8.setBounds(825,570,120,40);
 	...
 	public void dataBaseUpdate()
 	{
 	 try{
 	 	...
 	 	boolean alreadyVote = false;
			 ...
			 ResultSet res=stm.executeQuery("SELECT count(*) FROM recommendation   WHERE  Title = '"+tf1.getText()+"' ");
			 ...
			 while(res.next())
			 {
			 	...
			 	if(rows>0)
			 	{
			   JOptionPane.showMessageDialog(this,"This book is alreay recommended ","Error",JOptionPane.WARNING_MESSAGE);
			     alreadyVote = true;
			 	}
	     ...
	     try
	         {
			      ...
			      Statement stm1=conn.createStatement();
			 	  ...
			 	  stm1.executeUpdate("INSERT INTO recommendation  (Title,author1 ,author2 ,author3,Edition,ISBN,Publisher,City,Year,recomendedby,Name) VALUE('" + tf1.getText() + "','"+tf2.getText()+"','" + tf3.getText() + "','"+ tf4.getText() +"','"+(String)cb.getSelectedItem()+"','" + tf5.getText()+ "','"+tf6.getText()+"','"+tf7.getText()+"','"+tf8.getText()+"','"+userID+"','"+name+"')");
