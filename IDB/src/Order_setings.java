...
public class Order_setings extends JFrame  implements ActionListener
{
	private String heading[]={"Book-ID","Title","Author","Edition","ISBN","Publisher","Quentity","Price"};
   ...
   private String []selected_data=new String[200];
    ...
    public JComboBox vendername_selecter;
    private ResultSet reset=null;
    private Statement stm=null;



public Order_setings()
{

	    setTitle("Order prepairing -Ordered by vender name");
		setSize(1024,768);
		setResizable(true);
		 db();
		Order_setings_gui();
...
{
	Order_setings vender_selecter=new Order_setings();
...
recomand=new JButton("save order");
...
public void actionPerformed(ActionEvent e)
 	{
			...
			if(e.getSource()==select || e.getSource()==vendername_selecter)
			{
	...
	DetailAdder form=new DetailAdder();
			...
			{
				OrderList orderlist=new OrderList((String)vendername_selecter.getSelectedItem());
...
try{
String query="SELECT bookid,title,author1 ,edition,isbn,publisher,copy,price FROM select_to_order where status='0' and vender='"+vendername_selecter.getSelectedItem()+"'";
