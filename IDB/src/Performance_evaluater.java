...
public class Performance_evaluater extends Applet {
...
//    "0=machanical;1=maths;2=chemical;3=electrical;4=civil;5=material;6=IT"
  ...
  private Panel createControlPanel() {
    ...
    Button startButton = new Button("Most used subject of book");
    						Font f=new Font("Tahoma",Font.BOLD,20);
							Color ctf1=new Color(255,0,0);
 ...
 /* //--------------------------------------------------------
       Button startButton2 = new Button("Least used subject of book");
						startButton2.setFont(f);
						startButton2.setForeground(ctf1);
...
void calculate_data()
{
  ...
  frame = new Frame("Book usage in subjectwise");
    frame.addWindowListener(new WindowAdapter() {
              public void windowClosing(WindowEvent event) {
                System.exit(0);
              }
